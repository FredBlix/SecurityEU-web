...
if (contactForm) {
  contactForm.addEventListener('submit', async (e) => {
    ...
    // Generate UUIDs for session and respondent
    const generateUUID = () => {
    ...
    if (serviceValue) {
      responses['b85701bb-fd0a-476a-be0a-c2df7f0376fe'] = serviceValue;
    }
    ...
    console.log('Sending to Tally:', JSON.stringify(formData));
